function mutural_informationR=mutural_information(grey_matrixA,grey_matrixB,grey_matrixF)
...
HFA=Hab(grey_matrixF,grey_matrixA);
HFB=Hab(grey_matrixF,grey_matrixB);
MIFA=HA+HF-HFA;
MIFB=HB+HF-HFB;
